# PYNQ-Z1 PS7 preset, generated from boards/arty-z7-20/A.0/preset.xml.
#
# The PYNQ-Z1 is Digilent hardware and is the same PCB as the Arty Z7-20, which is the name
# Digilent's board files use -- there is no "pynq-z1" board part. Part is xc7z020clg400-1,
# identical to the Z2, so every area and timing result carries over unchanged.
#
# The DDR device is also identical to the Z2's (MT41J256M16RE-125, 16-bit, 525 MHz, CL7,
# same bank/row/col geometry) -- but the TIMINGS DIFFER: T_RCD and T_RP are 7 here against
# 13.125 in TUL's Z2 file. That is exactly the class of silent misconfiguration that
# PCW_IMPORT_BOARD_PRESET already caused once, so this preset is applied explicitly and
# asserted in tcl/verify_ps7_z1.tcl. Do not reuse the Z2 preset on a Z1.
#
# Generated -- do not hand-edit. Regenerate with scripts/gen_ps7_preset.py.

proc apply_ps7_preset_pynqz1 {ip} {
