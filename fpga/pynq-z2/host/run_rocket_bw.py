#!/usr/bin/env python3
"""Load the full-feature + bandwidth-instrument bitstream and run a program on it.
...
MAGIC registry (tcl/build_rocket.tcl):
  ...
  0x5A5A0007  + the TileLink bandwidth instrument
"""
import os
import sys
...
run_rocket.EXPECT_MAGIC = 0x5A5A_0007
