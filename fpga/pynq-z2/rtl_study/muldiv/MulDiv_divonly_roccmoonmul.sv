...
module MulDiv(	// @[generators/rocket-chip/src/main/scala/rocket/Multiplier.scala:40:7]
  ...
  wire [1:0]   _decoded_andMatrixOutputs_T = {~(io_req_bits_fn[0]), io_req_bits_fn[2]};	// @[src/main/scala/chisel3/util/experimental/decode/decoder.scala:35:16, src/main/scala/chisel3/util/pla.scala:78:21, :90:45, :98:53]
  ...
  wire         _GEN_1 = state == 3'h3;	// @[generators/rocket-chip/src/main/scala/rocket/Multiplier.scala:51:22, :129:39]
  ...
  wire         _eOut_T = count == 7'h0;	// @[generators/rocket-chip/src/main/scala/rocket/Multiplier.scala:54:18, :146:24]
  ...
  wire         _GEN_3 = io_req_ready_0 & io_req_valid;	// @[generators/rocket-chip/src/main/scala/rocket/Multiplier.scala:183:25, src/main/scala/chisel3/util/Decoupled.scala:51:35]
  wire         eOut = _eOut_T & ~divby0 & _eOutPos_T != 6'h3F;	// @[generators/rocket-chip/src/main/scala/rocket/Multiplier.scala:146:{24,32}, :152:35, :153:{32,35,43,54}]
  always @(posedge clock) begin	// @[generators/rocket-chip/src/main/scala/rocket/Multiplier.scala:40:7]
    if (reset)	// @[generators/rocket-chip/src/main/scala/rocket/Multiplier.scala:40:7]
      ...
      state <= {1'h0, ~(lhs_sign | rhs_sign), 1'h1};	// @[generators/rocket-chip/src/main/scala/rocket/Multiplier.scala:51:22, :81:23, :165:{36,46}]
    ...
    if (_GEN_3) begin	// @[src/main/scala/chisel3/util/Decoupled.scala:51:35]
      ...
      count <= 7'h0;	// @[generators/rocket-chip/src/main/scala/rocket/Multiplier.scala:54:18]
      ...
      if (_GEN_1) begin	// @[generators/rocket-chip/src/main/scala/rocket/Multiplier.scala:129:39]
        count <= eOut ? {1'h0, ~_eOutPos_T} : count + 7'h1;	// @[generators/rocket-chip/src/main/scala/rocket/Multiplier.scala:54:18, :144:{11,20}, :152:{21,35}, :153:{32,43}, :154:19, :156:15]
        remainder <= eOut ? {3'h0, {63'h0, remainder[63:0]} << ~_eOutPos_T} : {1'h0, _subtractor_T_1[64] ? remainder[127:64] : _subtractor_T_1[63:0], remainder[63:0], ~(_subtractor_T_1[64])};	// @[generators/rocket-chip/src/main/scala/rocket/Multiplier.scala:61:22, :88:37, :89:57, :133:28, :134:{14,24,45,67}, :137:15, :152:{21,35}, :153:{32,43}, :154:19, :155:{19,39}]
      end
    ...
    neg_out <= _GEN_3 ? ((&_decoded_andMatrixOutputs_T_1) ? lhs_sign : lhs_sign != rhs_sign) : ~(_GEN_1 & divby0 & ~isHi) & neg_out;	// @[generators/rocket-chip/src/main/scala/rocket/Multiplier.scala:57:20, :58:17, :81:23, :129:{39,50}, :146:32, :159:{18,21,28,38}, :164:22, :169:{13,19,46}, src/main/scala/chisel3/util/Decoupled.scala:51:35, src/main/scala/chisel3/util/pla.scala:98:{53,70}]
