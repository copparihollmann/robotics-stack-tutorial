...
"""Batch ONE REGION of the merged encoder+decoder graph: B utterances decoded at once.
    ...
    python3 fpga/pynq-z2/modelblaster/ir_regbatch.py --selftest
    python3 fpga/pynq-z2/modelblaster/ir_regbatch.py --ir in/graph.json --out out/graph.json \
...
import ir_batch                                                          # noqa: E402
import ir_cse                                                            # noqa: E402
