#!/usr/bin/env python3
"""Load the lever-3-on-HP2 bitstream (0x5A5A0014): two memory channels, HP0 + HP2, one clock.
...
MAGIC registry (tcl/build_rocket.tcl):
  ...
  0x5A5A0014  lever 3 with channel 1 on S_AXI_HP2 (the other DDR controller port)
"""
import os
import sys
...
run_rocket.EXPECT_MAGIC = 0x5A5A_0014
