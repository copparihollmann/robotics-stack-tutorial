 ...
 * ModelBlaster's kernel_linear_s8 reference_impl, verbatim (pipeline/reference_kernels.py),
 * renamed.  The engine and the curated MBP kernel are both checked against THIS. */
#include <stdint.h>
