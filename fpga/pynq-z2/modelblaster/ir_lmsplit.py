...
"""Split a `linear_s8` that is too wide to image in one piece into N-shards, IN THE GRAPH.
    ...
    python3 fpga/pynq-z2/modelblaster/ir_lmsplit.py --selftest
    python3 fpga/pynq-z2/modelblaster/ir_lmsplit.py --ir in/graph.json --weights in/weights.npz \
...
import ir_cse                                    # the verifier, not re-implemented here
